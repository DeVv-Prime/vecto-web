# app.py - Vecto Nodes Complete Platform (3000+ lines)
# Features: Registration Required, Home Page, Plan Pages, Reviews, Dashboard, Admin Panel
import os
import json
import secrets
import hashlib
...
def load_db():
    ...
    return {
        ...
        "plans": {
            "VPS": [
                {"id": "vps-1", "name": sc("VPS Starter"), "cpu": sc("1 Core"), "ram": "1GB", "storage": "25GB SSD", "bandwidth": "1TB", "price": 4.99, "popular": False, "emoji": "🖥️"},
                {"id": "vps-2", "name": sc("VPS Pro"), "cpu": sc("2 Cores"), "ram": "2GB", "storage": "50GB SSD", "bandwidth": "2TB", "price": 9.99, "popular": True, "emoji": "⚡"},
                {"id": "vps-3", "name": sc("VPS Enterprise"), "cpu": sc("4 Cores"), "ram": "4GB", "storage": "100GB SSD", "bandwidth": "4TB", "price": 19.99, "popular": False, "emoji": "🚀"},
                {"id": "vps-4", "name": sc("VPS Ultimate"), "cpu": sc("8 Cores"), "ram": "8GB", "storage": "200GB NVMe", "bandwidth": "8TB", "price": 39.99, "popular": False, "emoji": "👑"}
            ],
            "RDP": [
                {"id": "rdp-1", "name": sc("RDP Basic"), "cpu": sc("1 Core"), "ram": "2GB", "storage": "40GB SSD", "price": 9.99, "emoji": "💻", "popular": False},
                {"id": "rdp-2", "name": sc("RDP Pro"), "cpu": sc("2 Cores"), "ram": "4GB", "storage": "80GB SSD", "price": 19.99, "emoji": "🎮", "popular": True},
                {"id": "rdp-3", "name": sc("RDP Business"), "cpu": sc("4 Cores"), "ram": "8GB", "storage": "160GB SSD", "price": 39.99, "emoji": "🏢", "popular": False}
            ],
            "MC": [
                {"id": "mc-1", "name": sc("MC Basic"), "ram": "1GB", "slots": 10, "price": 4.99, "emoji": "🌱", "popular": False},
                {"id": "mc-2", "name": sc("MC Pro"), "ram": "2GB", "slots": 25, "price": 9.99, "emoji": "⚔️", "popular": True},
                {"id": "mc-3", "name": sc("MC Ultimate"), "ram": "4GB", "slots": 50, "price": 19.99, "emoji": "👑", "popular": False},
                {"id": "mc-4", "name": sc("MC Extreme"), "ram": "8GB", "slots": 100, "price": 39.99, "emoji": "💎", "popular": False}
            ],
            "GAMES": [
                {"id": "game-1", "name": sc("Game Basic"), "ram": "2GB", "slots": 20, "price": 14.99, "emoji": "🎮", "popular": False},
                {"id": "game-2", "name": sc("Game Pro"), "ram": "4GB", "slots": 50, "price": 29.99, "emoji": "🎯", "popular": True},
                {"id": "game-3", "name": sc("Game Ultimate"), "ram": "8GB", "slots": 100, "price": 59.99, "emoji": "🏆", "popular": False}
            ],
            "NITRO": [
                {"id": "nitro-1", "name": sc("Nitro Basic"), "duration": sc("1 Month"), "price": 4.99, "emoji": "💜", "popular": False},
                {"id": "nitro-2", "name": sc("Nitro Basic"), "duration": sc("3 Months"), "price": 12.99, "emoji": "💜", "popular": False},
                {"id": "nitro-3", "name": sc("Nitro Premium"), "duration": sc("1 Month"), "price": 9.99, "emoji": "💎", "popular": True},
                {"id": "nitro-4", "name": sc("Nitro Premium"), "duration": sc("3 Months"), "price": 24.99, "emoji": "💎", "popular": False}
            ],
            "NITROTRIAL": [
                {"id": "trial-1", "name": sc("Nitro Trial"), "duration": sc("14 Days"), "price": 2.99, "emoji": "🎁", "popular": True},
                {"id": "trial-2", "name": sc("Nitro Trial"), "duration": sc("1 Month"), "price": 4.99, "emoji": "🎟️", "popular": False}
            ]
        },
        "orders": [],
        "pending_approvals": [],
        "approved_orders": [],
        "reviews": [
            {"name": sc("Alex Johnson"), "rating": 5, "comment": sc("Amazing VPS hosting! Very fast and reliable. Definitely recommend!"), "date": "2024-01-15", "avatar": "👨"},
            {"name": sc("Sarah Williams"), "rating": 5, "comment": sc("Best Minecraft server hosting I've ever used! Zero lag and great support."), "date": "2024-01-20", "avatar": "👩"},
            {"name": sc("Michael Chen"), "rating": 5, "comment": sc("Great support team, very responsive. Helped me set up my server quickly."), "date": "2024-01-25", "avatar": "👨"},
            {"name": sc("Emily Davis"), "rating": 5, "comment": sc("Discord Nitro delivered instantly! Will buy again. Very trustworthy."), "date": "2024-02-01", "avatar": "👩"},
            {"name": sc("James Wilson"), "rating": 5, "comment": sc("RDP works flawlessly. Highly recommended for business use!"), "date": "2024-02-05", "avatar": "👨"},
            {"name": sc("Lisa Brown"), "rating": 5, "comment": sc("Good prices and excellent uptime. Never had any issues."), "date": "2024-02-10", "avatar": "👩"},
            {"name": sc("David Lee"), "rating": 5, "comment": sc("The game servers are incredibly fast. My Rust server runs perfectly."), "date": "2024-02-15", "avatar": "👨"},
            {"name": sc("Jessica Taylor"), "rating": 5, "comment": sc("Best hosting provider I've found. Will be using for all my projects."), "date": "2024-02-20", "avatar": "👩"}
        ],
        "stats": {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-links a:hover, .nav-links a.active { color: {{ primary_color }}; }
        .btn-login {
            background: linear-gradient(135deg, {{ primary_color }}, {{ secondary_color }});
        ...
        .plan-emoji { font-size: 3rem; margin-bottom: 1rem; }
        ...
        .review-name { font-weight: 600; font-variant: small-caps; }
...
<body>
    ...
    <div class="hero">
        <div class="hero-content">
            <h1>ᴛʜᴇ ꜱᴛʀᴏɴɢᴇꜱᴛ ʜᴏꜱᴛɪɴɢ ᴘʟᴀᴛꜰᴏʀᴍ</h1>
            <p>Enterprise multi-infrastructure for Microsoft VPS & domains, instant deployment, always-on protection. 24/7 support.</p>
    ...
    <div class="plans-section">
        <h2 class="section-title">🔥 ʜᴏᴛ ꜱᴇʟʟɪɴɢ ᴘʟᴀɴꜱ</h2>
        <p class="section-subtitle">ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴘᴇʀꜰᴇᴄᴛ ᴘʟᴀɴ ꜰᴏʀ ʏᴏᴜʀ ɴᴇᴇᴅꜱ</p>
    ...
    <div class="reviews-section">
        <h2 class="section-title">⭐ ᴄᴜꜱᴛᴏᴍᴇʀ ʀᴇᴠɪᴇᴡꜱ</h2>
        <p class="section-subtitle">ᴡʜᴀᴛ ᴏᴜʀ ᴄʟɪᴇɴᴛꜱ ꜱᴀʏ ᴀʙᴏᴜᴛ ᴜꜱ</p>
        <div class="reviews-grid">
            ...
            <div class="review-card">
                ...
                <div class="review-name">{{ review.avatar }} {{ review.name }}</div>
    ...
    <div class="cta-section">
        <h2 style="margin-bottom:1rem;">ʀᴇᴀᴅʏ ᴛᴏ ɢᴇᴛ ꜱᴛᴀʀᴛᴇᴅ?</h2>
        <p style="margin-bottom:2rem;">ᴊᴏɪɴ ᴛʜᴏᴜꜱᴀɴᴅꜱ ᴏꜰ ꜱᴀᴛɪꜱꜰɪᴇᴅ ᴄᴜꜱᴛᴏᴍᴇʀꜱ ᴛᴏᴅᴀʏ</p>
        <button class="btn-cta" onclick="window.location.href='/register'">ɢᴇᴛ ꜱᴛᴀʀᴛᴇᴅ →</button>
    </div>
...
def generate_plan_page(title, plans, category):
    ...
    for p in plans:
        ...
        if 'cpu' in p:
            ...
            features_html = f'<li>✅ RAM: {p["ram"]}</li><li>✅ Slots: {p["slots"]}</li><li>✅ DDoS Protection</li><li>✅ 24/7 Support</li>'
        elif 'duration' in p:
            features_html = f'<li>✅ Duration: {p["duration"]}</li><li>✅ Instant Delivery</li><li>✅ 24/7 Support</li><li>✅ Money Back Guarantee</li>'
        else:
            features_html = '<li>✅ Premium Features</li><li>✅ 24/7 Support</li><li>✅ DDoS Protection</li><li>✅ Money Back Guarantee</li>'
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .nav-links a:hover, .nav-links a.active {{ color: {primary}; }}
        ...
        .popular-badge {{ position: absolute; top: -12px; right: 20px; background: #F59E0B; color: #1a1a1a; padding: 4px 12px; border-radius: 20px; font-size: 0.7rem; font-weight: 700; font-variant: small-caps; }}
...
<body>
    ...
    <div class="plans-header">
        <h1>{title}</h1>
        <p>{sc("Choose the perfect plan for your needs")}</p>
    </div>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error { background: rgba(239,68,68,0.2); color: #EF4444; padding: 10px; border-radius: 8px; margin-bottom: 1rem; text-align: center; }
        .success { background: rgba(16,185,129,0.2); color: #10B981; padding: 10px; border-radius: 8px; margin-bottom: 1rem; text-align: center; }
    </style>
</head>
<body>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-content { margin-left: 280px; padding: 2rem; width: 100%; }
        .welcome-card {
        ...
        .pending-card {
            background: #1A1A2E; border-radius: 16px; padding: 1rem;
...
<body>
    ...
    <div class="dashboard-container">
        <div class="sidebar">
            ...
            <div class="nav-item" onclick="location.href='/admin/pending'"><i class="fas fa-clock"></i> PENDING APPROVALS</div>
            <div class="nav-item" onclick="location.href='/admin/approved'"><i class="fas fa-check-circle"></i> APPROVED ORDERS</div>
            <div class="nav-item" onclick="location.href='/admin/users'"><i class="fas fa-users"></i> MANAGE USERS</div>
        ...
        <div class="main-content">
            ...
            {% if session.role == 'superadmin' and pending_count > 0 %}
            <div class="admin-section">
                <h3>⏳ {{ sc("Pending Approvals") }} ({{ pending_count }})</h3>
                {% for order in pending_orders[:3] %}
                <div class="pending-card">
                    <p><strong>{{ order.plan_name }}</strong> - ${{ order.price }} - {{ order.user_email }}</p>
                    <button onclick="approveOrder('{{ order.id }}')" style="background:#10B981; color:white; border:none; padding:5px 15px; border-radius:20px; margin-right:10px;">✅ Approve</button>
                    <button onclick="rejectOrder('{{ order.id }}')" style="background:#EF4444; color:white; border:none; padding:5px 15px; border-radius:20px;">❌ Reject</button>
                </div>
                {% endfor %}
            </div>
            {% endif %}
...
def dashboard():
    ...
    pending_orders = data['pending_approvals']
...
def admin_pending():
    ...
    <!DOCTYPE html>
    <html>
    <head><title>Pending Approvals</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"><style>
        *{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Inter',sans-serif;background:#0A0A0A;color:#E2E8F0;padding:2rem;}
        .container{max-width:1200px;margin:0 auto;}.card{background:#1A1A2E;border-radius:20px;padding:1.5rem;margin-bottom:1rem;border:1px solid rgba(255,255,255,0.05);}
        .btn{background:linear-gradient(135deg,{{ primary }},{{ secondary }});color:white;border:none;padding:8px 20px;border-radius:40px;cursor:pointer;margin-right:10px;}
        .btn-danger{background:#EF4444;}.back-link{color:{{ primary }};text-decoration:none;margin-bottom:1rem;display:inline-block;}
    </style></head>
    <body>
...
def admin_approved():
    ...
    <!DOCTYPE html>
    <html>
    <head><title>Approved Orders</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"><style>
        *{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Inter',sans-serif;background:#0A0A0A;color:#E2E8F0;padding:2rem;}
        .container{max-width:1200px;margin:0 auto;}table{width:100%;border-collapse:collapse;}th,td{padding:12px;text-align:left;border-bottom:1px solid rgba(255,255,255,0.05);}
    ...
    ''', approved=data['approved_orders'], primary=data['site_config']['primary_color'], secondary=data['site_config']['secondary_color'])
...
def admin_users():
    ...
    <!DOCTYPE html>
    <html>
    <head><title>Manage Users</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"><style>
        *{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Inter',sans-serif;background:#0A0A0A;color:#E2E8F0;padding:2rem;}
        .container{max-width:1200px;margin:0 auto;}table{width:100%;border-collapse:collapse;}th,td{padding:12px;text-align:left;border-bottom:1px solid rgba(255,255,255,0.05);}
        .back-link{color:{{ primary }};text-decoration:none;margin-bottom:1rem;display:inline-block;}.btn{background:{{ primary }};color:white;border:none;padding:4px 12px;border-radius:20px;cursor:pointer;}
    </style></head>
    <body>
    <div class="container"><a href="/dashboard" class="back-link">← Back to Dashboard</a>
...
def admin_settings():
    ...
    <!DOCTYPE html>
    <html>
    <head><title>Settings</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"><style>
        *{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Inter',sans-serif;background:#0A0A0A;color:#E2E8F0;padding:2rem;}
        .container{max-width:800px;margin:0 auto;}.card{background:#1A1A2E;border-radius:20px;padding:1.5rem;margin-bottom:1rem;border:1px solid rgba(255,255,255,0.05);}
        input,select{width:100%;padding:10px;margin:10px 0;border-radius:12px;background:#0A0A0A;border:1px solid rgba(255,255,255,0.1);color:white;}
        .btn{background:linear-gradient(135deg,{{ primary }},{{ secondary }});color:white;border:none;padding:10px 20px;border-radius:40px;cursor:pointer;}
        .back-link{color:{{ primary }};text-decoration:none;margin-bottom:1rem;display:inline-block;}
    </style></head>
    <body>
    <div class="container"><a href="/dashboard" class="back-link">← Back to Dashboard</a>
